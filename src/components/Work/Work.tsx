 ...
 return (
  <div>
   <motion.h2
    ...
    className="text-3xl font-medium capitalize text-center sm:text-4xl sm:my-18"
   >
     ...
     >
      ...
      >
       <div className="bg-blue-100/50 rounded-2xl overflow-hidden">
        <Image
         src={item?.image ?? "/shell.jpg"}
         priority
         width={1000}
         height={1000}
         alt={"work"}
         className="w-full h-48 sm:h-96 object-center object-contain"
        />
       </div>
